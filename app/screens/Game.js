...
import {View, ScrollView, ImageBackground, Image, Text, TouchableOpacity} from 'react-native'
      ...
      <View style={{
        ...
        <View style={{width: wp('100%'), height: hp('20%'), backgroundColor: '#ed8687'}}>
          <ScrollView horizontal={true}>
            ...
            <TouchableOpacity onPress={this.onPressItem('desk')}>
            ...
            <TouchableOpacity onPress={this.onPressItem('tank')}>
              <View style={{backgroundColor: '#ffffff', paddingTop: 10, paddingBottom: 10,marginTop: 20, marginBottom: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TouchableOpacity onPress={this.onPressItem('fish01')}>
              <View style={{backgroundColor: '#ffffff', paddingTop: 10, paddingBottom: 10,marginTop: 20, marginBottom: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TouchableOpacity onPress={this.onPressItem('khaze')}>
              <View style={{backgroundColor: '#ffffff', paddingTop: 10, paddingBottom: 10,marginTop: 20, marginBottom: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TouchableOpacity onPress={this.onPressItem('books')}>
              <View style={{backgroundColor: '#ffffff', paddingTop: 10, paddingBottom: 10,marginTop: 20, marginBottom: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TouchableOpacity onPress={this.onPressItem('chair')}>
              <View style={{backgroundColor: '#ffffff', paddingTop: 10, paddingBottom: 10,marginTop: 20, marginBottom: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TouchableOpacity onPress={this.onPressItem('komod')}>
              <View style={{backgroundColor: '#ffffff', paddingTop: 10, paddingBottom: 10,marginTop: 20, marginBottom: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TouchableOpacity onPress={this.onPressItem('lamp')}>
              <View style={{backgroundColor: '#ffffff', paddingTop: 10, paddingBottom: 10,marginTop: 20, marginBottom: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TouchableOpacity onPress={this.onPressItem('pot')}>
              <View style={{backgroundColor: '#ffffff', paddingTop: 10, paddingBottom: 10,marginTop: 20, marginBottom: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
