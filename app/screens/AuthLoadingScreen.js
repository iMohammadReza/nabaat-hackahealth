...
import padidar from '../assets/icons/padidar.png'
        ...
        <View style={{flex:1, justifyContent:"center", backgroundColor:"white"}}>
          ...
          <View style={{flex:5, justifyContent:"center", flexDirection:"row"}} >
            <View style={{justifyContent:"center", flexDirection:"column"}} >
              ...
              />
              {/* <Text style={{fontFamily:"IRANSansMobile_Bold", color:"#22b4c5", fontSize:28, margin:16, textAlign:"center"}} >پدیدار من</Text> */}
            </View>
          </View>
