                ...
                <View style={{flex: 1, marginTop: wp('10%'), alignContent:"center", justifyContent: 'center'}} >
                  ...
                  <View>
                    {this.state.q.options.map(item=>{
                      return  <Button  style={{backgroundColor: '#ffffff', borderColor: '#ed8687', borderWidth: 4, justifyContent: 'center', marginTop: wp('5%'), width: wp('50%'), height: hp('7%') }} onPress={() => this.sendAnswer(this.state.q.id, item.qid, this.state.q.fvalue)}>
